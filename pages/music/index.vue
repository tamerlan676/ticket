    ...
    .ticket-wrapper
        ...
        .options
         ...
         form(name="song" method="POST" data-netlify="true")
            ...
            .field-block
                input(class="input"  type="text" @input="changeSong"  placeholder="Введите название песни")
                input(class="input" type="text" @input="changeArtist"  placeholder="Введите исполнителей")
